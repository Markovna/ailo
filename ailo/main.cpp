...
private:
    ...
    void createLogicalDevice() {
        ...
        // Build list of device extensions, adding portability extensions if available
        std::vector<const char*> enabledExtensions(deviceExtensions.begin(), deviceExtensions.end());

        // Check for portability subset support (required for MoltenVK on macOS)
        ...
        // Add portability extensions if available (MoltenVK requirement)
        // Note: VK_KHR_get_physical_device_properties2 was promoted to core in Vulkan 1.1
        // but MoltenVK still requires it as an extension dependency
